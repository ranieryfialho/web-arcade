        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-background-tertiary bg-background-card p-6 shadow-xl">
              ...
              {/*
                IMPORTANTE: action aponta para createGame.
                encType NÃO é multipart/form-data pois os arquivos
                já foram enviados diretamente ao Supabase pelo FileUpload.
                O formulário só envia texto + URLs ocultas.
              */}
              <form action={createGame as any} className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs font-bold uppercase text-text-muted mb-1 block">
                      Capa
                    </label>
                    <FileUpload
                      name="cover_url"
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              {games?.map((game: any) => (
                <div
                  key={game.id}
                  className="flex items-start gap-4 rounded-xl border border-background-tertiary bg-background-card p-4 transition-all hover:border-brand-primary/50 group"
                >
